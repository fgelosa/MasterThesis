kubectl create configmap authz-policy --from-file frontend/policy-frontend.rego --from-file auth-api/policy.rego --from-file todos-api/policy.rego --from-file users-api/policy.rego --from-file redis-queue/policy.rego
